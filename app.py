...
# --- LEFT SIDEBAR CONTROLS (Static parameters only) ---
...
# --- INITIALIZE ALL BASE TRACES FOR SUBPLOTS ---
# Subplot 1 Base Traces
...
# --- BUILD ANIMATION FRAMES (Client-Side Javascript) ---
frames_list = []
animation_steps = 40
...
for i, phi in enumerate(phases):
  ...
  frame_data = [
      go.Scatter3d(x=x, y=ey, z=np.zeros_like(x)),  # Index 2
      go.Scatter3d(
...
# Layout & Play/Pause Button Configuration anchored cleanly at top
fig.update_layout(
    height=550,
...
# Render cleanly once per load without triggering python loop reruns
